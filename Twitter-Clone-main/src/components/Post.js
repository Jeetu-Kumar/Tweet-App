    ...
    <div className="post">
      <div className={`post-comment ${post.commentCheck ? "active" : ""}`}>
        <div className="post-comment__inner">
          <button
            className="post-comment__close"
            onClick={() => dispatch(commentCheck(post.id))}
          >
            X
          </button>
      ...
      <div className="post-content">
        ...
        <Link to={`/post/${post.id}`}>
          <div className="post-text">{post.article}</div>
        </Link>
        ...
        <div className="post-actions">
          ...
          <button
            className={`${post.likeCheck ? "like-active" : ""}`}
